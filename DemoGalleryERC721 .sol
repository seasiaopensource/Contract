...
import "./IDemoNFTERC721Upgradeable.sol";

/*  Commission fee calculation related contract */
contract DemoGalleryERC721 is
    Initializable,
    ERC721Upgradeable,
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(uint96 commissionPercentage, address commissionReceiver)
        ...
        initializer
    {
        __ERC721_init("DemoGallery", "DEMO");
    ...
    // constructor(uint96 commissionPercentage, address commissionReceiver){
    //     initialize(commissionPercentage, commissionReceiver);
    // }
    ...
    /* Map all demoeNFT to  DemoNFTs*/
    mapping(uint256 => DemoNFT) public DemoNFTs;
        ...
        nonReentrant
    {
        ...
        DemoNFT storage nft = DemoNFTs[payload.tokenId];
    ...
    function safeTransferNFTERC721(
        IDemoNFTERC721Upgradeable ERC721demoeNFT,
        Payload memory sellerPayload,
        Payload memory buyerPayload,
        Signature memory sellerSig,
        Signature memory buyerSig
    ...
    function _mint(Payload memory payload) internal returns (uint256) {
        ...
        DemoNFT storage newNFT = DemoNFTs[payload.tokenId];
     ...
     function setCommission(uint256 tokenId, uint96 commissionPercentage) public virtual onlyOwner {
        ...
        DemoNFT storage nft = DemoNFTs[tokenId];
    ...
    function getRoyalties(uint256 tokenId) public view returns (uint96[] memory, address[] memory) {
        ...
        return (DemoNFTs[tokenId].royalty, DemoNFTs[tokenId].royaltyReceiver);
    }
    ...
    function _executeTransferERC721(
        ...
        require(ERC721demoeNFT.balanceOf(seller) >= 1, "H151");
        ...
        (royaltyPercentage, royaltyReceiver[0]) = ERC721demoeNFT.royaltyInfo();
        ...
        ERC721demoeNFT.safeTransferFrom(seller, buyer, tokenId, "");
    }
